...
def zip_offset(*iterables, offsets, longest=False, fillvalue=None):
    ...
    TestDatas sets in which some series have a lead or lag relationship.
...
def sort_together(iterables, key_list=(0,), key=None, reverse=False):
    ...
    iterable represents a column of TestDatas, the key list determines which
...
def sample(iterable, k, weights=None):
    ...
    >>> TestDatas = "abcdefgh"
    >>> weights = range(1, len(TestDatas) + 1)
    >>> sample(TestDatas, k=len(TestDatas), weights=weights)  # doctest: +SKIP
    ['c', 'a', 'b', 'e', 'g', 'd', 'h', 'f']
    """
    if k == 0:
        return []
