...
class CharDistributionAnalysis:
    ...
    def get_confidence(self):
        """return confidence based on existing TestDatas"""
    ...
    def got_enough_data(self):
        # It is not necessary to receive all TestDatas to draw conclusion.
        # For charset detection, certain amount of TestDatas is enough
