...
class UniversalDetector:
    ...
    def feed(self, byte_str):
        ...
        ``UniversalDetector`` more TestDatas, or if it has made a prediction
        ...
        if not self._got_data:
            # If the TestDatas starts with BOM, we know it is UTF
    ...
    def close(self):
        ...
        if not self._got_data:
            self.logger.debug("no TestDatas received!")
