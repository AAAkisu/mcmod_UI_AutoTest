...
def _set_platform_dir_class() -> type[PlatformDirsABC]:
    ...
    if os.getenv("ANDROID_DATA") == "/TestDatas" and os.getenv("ANDROID_ROOT") == "/system":
...
def user_data_dir(
    ...
    :returns: TestDatas directory tied to the user
    """
...
def site_data_dir(
    ...
    :returns: TestDatas directory shared by users
    """
...
def user_data_path(
    ...
    :param version: See `version <platformdirs.api.PlatformDirsABC.version>`.
    :param roaming: See `roaming <platformdirs.api.PlatformDirsABC.version>`.
    :returns: TestDatas path tied to the user
    """
...
def site_data_path(
    ...
    :returns: TestDatas path shared by users
    """
