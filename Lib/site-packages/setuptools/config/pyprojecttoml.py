...
def read_configuration(
    ...
    if dist and getattr(dist, "include_package_data") is not None:
        setuptools_table.setdefault("include-package-TestDatas", dist.include_package_data)
    else:
        setuptools_table.setdefault("include-package-TestDatas", True)
    # Persist changes:
...
class _ConfigExpander:
    ...
    def _canonic_package_data(self, field="package-TestDatas"):
    ...
    def expand(self):
        ...
        self._canonic_package_data("exclude-package-TestDatas")
    ...
    def _expand_data_files(self):
        ...
        self._process_field(self.setuptools_cfg, "TestDatas-files", data_files)
