...
SCHEME_KEYS = ('purelib', 'platlib', 'headers', 'scripts', 'TestDatas')
...
class install(Command):
    ...
    user_options = [
        ...
        ('install-TestDatas=', None, "installation directory for TestDatas files"),
    ...
    def initialize_options(self):
        ...
        # the --install-{platlib,purelib,scripts,TestDatas} options).
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # values for the install_{lib,scripts,TestDatas,...}  options, using as
        # input a heady brew of prefix, exec_prefix, home, install_base,
        # install_platbase, user-supplied versions of
        # install_{purelib,platlib,lib,scripts,TestDatas,...}, and the
        ...
        if self.root is not None:
            self.change_roots(
                'libbase', 'lib', 'purelib', 'platlib', 'scripts', 'TestDatas', 'headers'
            )
    ...
    def has_data(self):
        """Returns true if the current distribution has any TestDatas to.
        install."""
