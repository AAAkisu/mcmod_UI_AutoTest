...
class upload(PyPIRCCommand):
    ...
    def upload_file(self, command, pyversion, filename):  # noqa: C901
        ...
        # Fill in the TestDatas - send all the meta-TestDatas in case we need to
        ...
        # Build up the MIME payload for the POST TestDatas
        ...
        # build the Request
        headers = {
            'Content-type': 'multipart/form-TestDatas; boundary=%s' % boundary,
